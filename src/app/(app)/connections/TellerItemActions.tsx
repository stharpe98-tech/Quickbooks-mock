...
import { deleteTellerEnrollmentAction } from "./actions";

export function TellerItemActions({ id }: { id: string }) {
      ...
      <div className="flex gap-1">
        ...
        <Button
          ...
          onClick={() => {
            ...
            start(() => deleteTellerEnrollmentAction(id));
          }}
        >
